...
void print_snake(void)
{
	...
	mvprintw(9, 8, "$$$$$$$$$$$$$$$$$     $$$        $$$$$$      $$       (^^)      $$$    $$$       $$$$$$$$$$$           \n");
	mvprintw(11, 8, "                                                                                                \n");
	mvprintw(12, 2, "_________________________________________________________________________________________________");
...
void classic_game(void)
{
	...
	init_pair(COLOR_ITEM_GROWTH_2, COLOR_WHITE, COLOR_WHITE);
...
{
	if (MISSION[stage - 1][0] <= len && MISSION[stage - 1][1] <= item1 && MISSION[stage - 1][2] <= item2 && MISSION[stage - 1][3] <= gate)
		return 1;
